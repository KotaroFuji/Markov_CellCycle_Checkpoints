...
#Diploid daughter cells generated by erroneous mitosis are defined as type 1 cells
#Polyploid daughter cells generated by erroneous mitosis are defined as type 2 cells
			...
			if poolnum in pool_list:
				...
				for cellID in cellID_list:
					...
					for time in range(initial_time+1,maximum_minutes+1):
	 					...
	 					#-----DSB level---
						if time < 144:	#time 144 is when cells are exposed to DNA damage, so before, it's zero
							DSB = 0
						else:
